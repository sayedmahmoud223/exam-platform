...
router.get("/exams", authMiddleware([roles.TEACHER]), asyncHandler(teacherController.getAllTeachersLevelsWithExams))
router.patch("/:levelId/assign-student/:studentId", authMiddleware([roles.TEACHER]), asyncHandler(teacherController.assignStudentToLevel))
